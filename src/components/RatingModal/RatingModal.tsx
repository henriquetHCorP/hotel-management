...
const RatingModal:FC<Props> = props => {
    const {isOpen, ratingValue, setRatingValue, ratingText, setRatingText, reviewSubmitHandler, isSubmittingReview, SetIsSubmittingReview, toggleRatingModal} = props; 
  ...
  return (
    ...
    >
        <div className="bg-white w-96 p-4 rounded-lg shadow-lg">
            ...
            <div className="mb-4">
                <label className="block text-smm font-medium text-gray-700">
                    Review Text 
                </label>
                <textarea 
                   value={ratingText} 
