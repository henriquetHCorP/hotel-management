...
const UserDetails = (props:{params:{id:string}}) => {
    ...
    const reviewSubmitHandler = async () => {
        // console.log(ratingValue, ratingText); 
    ...
    <div className="container mx-auto px-2 md:px-4 py-10">
        ...
        <RatingModal isOpen={isRatingVisible} ratingValue={ratingValue} setRatingValue={setRatingValue} ratingText={ratingText} setRatingText={setRatingText} reviewSubmitHandler={reviewSubmitHandler} isSubmittingReview={isSubmittingReview} SetIsSubmittingReview={setIsRatingVisible} toggleRatingModal={toggleRatingModal}/> 
